<template>
  <div>
    ...
    >
      ...
      <h1 class="project-name">LetterMumu</h1>
      <h2 class="project-tagline">欢迎来到LetterMumu的个人博客。</h2>
      <a href="https://gitee.com/LetterMumu" target="_blank" class="btn">Gitee主页</a>
      <a href="https://gitee.com/LetterMumu" target="_blank" class="btn">博客源码</a>
    </section>
            ...
            <div class="el-card is-never-shadow">
              ...
              <div class="el-card__body">
                <ul role="menubar" class="el-menu">
                  <g-link
                    class="nav__link el-menu-item"
                    :class="
                    path === '/new' ? 'is-active' : ''
                  "
                    to="/new"
                  >
                    <i class="el-icon-star-off"></i>最新动态
                  </g-link>
                  <g-link
                    class="nav__link el-menu-item"
                    :class="
                  ...
                  "
                    to="/social"
                  >
                    <i class="el-icon-mobile-phone"></i>社交圈
                  </g-link>
                  <g-link
                    class="nav__link el-menu-item"
                    :class="
                  ...
                  "
                    to="/blog"
                  >
                    <i class="el-icon-edit-outline"></i>博客列表
                  </g-link>
                  <g-link
                    class="nav__link el-menu-item"
                    :class="
                  ...
                  "
                    to="/project"
                  >
                    <i class="el-icon-service"></i>开源项目
                  </g-link>
                </ul>
              </div>
            </div>
